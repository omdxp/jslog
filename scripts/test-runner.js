...
const tests = [
  ...
  },
  {
    ...
    expectations: [
      ...
      "TextHandler with source location",
      "source=src/examples/source-location.ts",
      "JSONHandler with source location",
      '"source":{"function"',
      '"file":"src/examples/source-location.ts"',
      "ColorHandler with source location",
      "source=src/examples/source-location.ts",
      "Source location in nested functions",
      "Called from inner function",
      "Source location in class methods",
      "Creating user",
      "Deleting user",
      "Source location at different log levels",
      "Debug message with source",
      "Info message with source",
      "Warning message with source",
      "Error message with source",
      "Source location with wrapper function",
      "Message from wrapper",
      "Handler without addSource",
